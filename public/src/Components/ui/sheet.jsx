...
function SheetContent({
  ...
  className={cn(
    ...
    "fixed z-50 flex flex-col gap-4 bg-linear-to-b from-[#07142B] to-[#0B1F45] border-none bg-clip-padding text-sm text-[#F5F7FA] shadow-lg transition duration-200 ease-in-out " +
