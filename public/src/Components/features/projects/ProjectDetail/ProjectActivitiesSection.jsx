    ...
    return (
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-5 grid gap-3 lg:grid-cols-3">
          {[
            ...
            },
            {
              ...
              description:
                "Aggiornamenti su stato progetto e checklist collegate.",
            },
          ].map((item) => (
            <div
              key={item.title}
        ...
        <div className="mt-5 rounded-xl border border-dashed border-slate-200 bg-slate-50 p-4 text-sm text-slate-500">
          Sezione ancora in sviluppo. Qui puoi ci sarà audit log filtrata per
          project_id, attività recenti o note operative.
        </div>
      </div>
    );
};
