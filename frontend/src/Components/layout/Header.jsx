  ...
  return (
    <header className="flex flex-wrap items-center justify-between gap-4 border-b border-slate-200 bg-white px-8 py-5">
      ...
      <button
        ...
        className="flex cursor-pointer items-center gap-3 rounded-full border border-slate-200 bg-slate-50 py-1.5 pl-2 pr-4 shadow-sm transition-colors hover:bg-slate-100"
      >
