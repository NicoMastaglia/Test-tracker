    ...
    <div className="flex flex-col gap-1.5 w-full">
      ...
      <div className="relative w-full">
        <input
          ...
          className={`w-full rounded-lg border border-slate-200 pl-3 pr-10 py-2.5 text-sm text-slate-900 transition-all focus:outline-none focus:ring-2 bg-white placeholder-slate-400 ${ringClass}`}
        />
        <button
          type="button"
